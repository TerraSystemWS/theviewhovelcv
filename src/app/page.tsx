        ...
        <div className="row align-items-center">
          <div className="col-xl-5 col-lg-6 lg-mb-30">
            <div className="accommodations__area-title">
              ...
              <a className="theme-btn" href="about.html">Read More<i className="fal fa-long-arrow-right"></i></a>
            </div>
          </div>
        ...
        <div className="row deluxe__area-active">
          <div className="col-xl-3 col-lg-4 mb-30 suite">
            <div className="deluxe__area-item"> 
              <div className="deluxe__area-item-image">
                <img className="img__full" src="assets/img/luxury/luxury-1.jpg" alt=""/>
              </div>
              <div className="deluxe__area-item-content"> 
                <h6><a href="#"><span>$134</span> / Night</a></h6>
                <h4><a href="room-details.html">Small Suite</a></h4>
                <a className="simple-btn" href="contact.html"><i className="far fa-chevron-right"></i>Booking Now</a> 
              </div>
            </div>
          </div>
          <div className="col-xl-6 col-lg-8 mb-30 suite">
            <div className="deluxe__area-item deluxe__area-item-hover"> 
              <div className="deluxe__area-item-image">
                <img className="img__full" src="assets/img/luxury/luxury-2.jpg" alt=""/>
              </div>
              <div className="deluxe__area-item-content"> 
          ...
          <div className="col-xl-3 col-lg-4 mb-30 family">
            <div className="deluxe__area-item"> 
              <div className="deluxe__area-item-image">
                <img className="img__full" src="assets/img/luxury/luxury-3.jpg" alt=""/>
              </div>
              <div className="deluxe__area-item-content"> 
          ...
          <div className="col-xl-6 col-lg-8 lg-mb-30 single">
            <div className="deluxe__area-item"> 
              <div className="deluxe__area-item-image">
                <img className="img__full" src="assets/img/luxury/luxury-4.jpg" alt=""/>
              </div>
              <div className="deluxe__area-item-content"> 
          ...
          <div className="col-xl-6 luxury">
            <div className="deluxe__area-item"> 
              <div className="deluxe__area-item-image">
                <img className="img__full" src="assets/img/luxury/luxury-5.jpg" alt=""/>
              </div>
              <div className="deluxe__area-item-content"> 
          ...
          <div className="col-xl-6 col-lg-6">
            <div className="feature__area-left">
              <div className="feature__area-left-title">
                ...
                <a className="theme-border-btn" href="services-details.html">Read More<i className="fal fa-long-arrow-right"></i></a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="blog__area-item">
              ...
              <div className="blog__area-item-content">
                ...
                <div className="blog__area-item-content-btn">
                  <a className="simple-btn-2" href="blog-details.html">Read More<i className="fal fa-long-arrow-right"></i></a>
                </div>
              </div>
            </div>
          </div>
